...
if __name__ == "__main__":
    ...
    gs = GridSearchCV(net, params, refit=False, cv=n_splits, scoring='neg_root_mean_squared_error', n_jobs=n_jobs, verbose=3)
    ...
    for i in range(n_splits):
        ...
        rmses_classical.append(-score[0])
        rmses_low.append(-score[1])
    
    print (ttest_rel(rmses_classical, rmses_low, alternative="less"))
